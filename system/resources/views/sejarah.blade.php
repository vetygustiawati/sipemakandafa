...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <section class="hero-wrap js-fullheight img" style="background-image: url(public/web/images/ws4.jpg);">
        ...
        <div class="row description js-fullheight align-items-left justify-content-left">
          <div class="col-md-8 text-left">
            <div class="text">
              ...
              <br>
              <br>
<h4><b>Sejarah Pondok Pesantren Darul Fadhilah Ketapang</b></h4>
              <h4 class="mb-5"><p style="text-align: justify;">Pada tahun 2015 Pondok Pesantren Darul Fadhilah memulai perjalanannya, saat itu jumlah santri putra hanya 28 orang dan santri putri hanya 11 orang dengan total keseluruhan 39 orang santri. Dari tahun pertama ini perjalanan Pondok Pesantren Darul Fadhilah hanyalah dibimbing oleh beberapa ustaz dan ustazah. Hingga pada tahun 2020 total santri putra ada 253 orang dan santri putri 203 orang, dan juga memiliki sekolah formal mulai dari PAUD, SD, SMP, SMA dan SMK. Kemudian dari pondoknya sendiri terdapat pilihan Hifzhil Quran dan Taklim Kutub. Selain itu, terdapat 104 majelis yang tersebar dimana - mana di bawah naungan Darul Fadhilah yang terdiri dari majelis bapak-bapak, ibu-ibu, remaja, hingga anak-anak.
                                  </p></h4>
