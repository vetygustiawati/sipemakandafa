      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a href="{{url('/')}}" class="nav-link icon d-flex align-items-center"><i class="fa fa-home mr-2"></i> Home</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <a class="carousel-control-prev" href="{{url('public')}}/dist/img/gambar1.jpeg" role="button" data-bs-slide="prev">
