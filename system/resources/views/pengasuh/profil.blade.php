...
<html lang="en">
  ...
  <div class="main-section" style="background: #EEE2DC; color: black; !important">

    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-light ftco-navbar-dark pt-2" id="ftco-navbar">
      <div class="container" >
        <a class="navbar-brand" href="{{url('/profil')}}" style="color: black">PONPES DAFA KETAPANG</a>
      ...
      <div class="container">
        <div class="row description js-fullheight align-items-center justify-content-center">
          <div class="col-md-8 text-center">
            <div class="text">
              <h1>PROFIL</h1>
              <h4 class="mb-5">Pondok Pesantren Darul Fadhilah Ketapang</h4>
            </div>
          </div>
        </div>
      </div>
