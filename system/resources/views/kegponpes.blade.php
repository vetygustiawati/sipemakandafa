        ...
        <div class="col-lg-12">
          ...
          <div class="row pt-md">
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/yfb.jpeg" class="img-responsive">
  
              </div>
              <h2>Majelis Yasin Fadhilah Bapak-Bapak</h2>
              
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/yfi.jpeg" class="img-responsive">
                
              </div>
             
              <h2>Majelis Yasin Fadhilah Ibu-Ibu</h2>
             
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/yfr.jpeg" class="img-responsive">
                
              </div>
  
              <h2>Majelis Yasin Fadhilah Remaja</h2>
              
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/laskar.jpeg" class="img-responsive">
                
              </div>
             
              <h2>Majelis Laskar Panglima Dafa</h2>
             
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/ams.jpeg" class="img-responsive">
                
              </div>
              
              <h2>Majelis Al-Maratush Shalilah</h2>
             
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/istighosah.jpeg" class="img-responsive">
                
              </div>
              
              <h2>Majelis Istighosah</h2>
              
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/fardhu.jpeg" class="img-responsive">

              </div>
              
              <h2>Majelis Fardhu Kifayah</h2>
              
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/maqdis.jpeg" class="img-responsive">
                
              </div>
              
              <h2>MAQDIS (Majelis Istima'il Qur'an Wal Hadist)</h2>
              
            </div>
            <br>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/kohweh.jpeg" class="img-responsive">
               
              </div>
             
              <h2>Majelis Kohweh</h2>
             
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/tawajuhan.jpeg" class="img-responsive">
                
              </div>
             
              <h2>Majelis Tawajuhan</h2>
             </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/hubbu thoha.jpeg" class="img-responsive">
               
              </div>
              
              <h2>Majelis Hubbu Thoha</h2>
             
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="{{url('public')}}/dist/img/jailani.jpeg" class="img-responsive">
               
              </div>
              
              <h2>Majelis Sholawat Al-Jailani</h2>
