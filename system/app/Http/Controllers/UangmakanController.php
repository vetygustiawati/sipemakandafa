...
class UangmakanController extends Controller{
	...
	function showAdmin(Uangmakan $uangmakan){
		$data['uangmakan'] = $uangmakan;
		return view('admin.uangmakan.show', $data);
	}
	function showPengasuh(Uangmakan $uangmakan){
		$data['uangmakan'] = $uangmakan;
		return view('pengasuh.uangmakan.show', $data);
	}
	...
	function kwitansiTinta(Uangmakan $uangmakan){
		$data['uangmakan'] = $uangmakan;
		return view('admin.uangmakan.kwitansiTinta', $data);
	}
